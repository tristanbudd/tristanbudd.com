    ...
    return (
      ...
      >
        ...
        <div className="3xl:h-10 3xl:w-10 4xl:h-12 4xl:w-12 5xl:h-14 5xl:w-14 relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-zinc-800 text-white transition-colors duration-300 group-hover/btn:bg-black group-focus/btn:bg-black">
          {type === "load-more" ? (
            <Plus className="3xl:h-5 3xl:w-5 4xl:h-6 4xl:w-6 5xl:h-7 5xl:w-7 h-4 w-4 transition-all duration-300 group-hover/btn:rotate-90 group-focus/btn:rotate-90" />
          ) : type === "refresh" ? (
            <RotateCw className="3xl:h-5 3xl:w-5 4xl:h-6 4xl:w-6 5xl:h-7 5xl:w-7 h-4 w-4 transition-all duration-500 group-hover/btn:rotate-360 group-focus/btn:rotate-360" />
          ) : (
            <ArrowRight className="3xl:h-5 3xl:w-5 4xl:h-6 4xl:w-6 5xl:h-7 5xl:w-7 h-4 w-4 transition-all duration-300 group-hover/btn:-rotate-45 group-focus/btn:-rotate-45" />
          )}
        </div>
      </button>
    );
