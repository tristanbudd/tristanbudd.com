      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              href={ctaHref}
              className="group/btn 3xl:py-2 3xl:pr-2 3xl:pl-8 3xl:text-base 4xl:py-2.5 4xl:pr-2.5 4xl:pl-10 4xl:text-lg 5xl:py-3 5xl:pr-3 5xl:pl-12 5xl:text-xl relative flex items-center justify-between gap-4 overflow-hidden rounded-full border-2 border-black bg-black py-1.5 pr-1.5 pl-6 text-sm font-semibold text-white transition-all duration-300 hover:text-black focus:outline-hidden focus-visible:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
