...
function BlogRow({
  ...
  return (
    <div
      className="group/blog 3xl:p-10 4xl:p-12 5xl:p-16 3xl:gap-10 relative flex flex-col gap-6 overflow-hidden rounded-2xl border border-zinc-200/60 bg-white/40 p-8 shadow-xs backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:border-zinc-300 hover:bg-white/80 hover:shadow-md md:flex-row md:items-start md:gap-8"
      style={{
        opacity: visible ? 1 : 0,
