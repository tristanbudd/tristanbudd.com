...
export default function PageLoader() {
  const [status, setStatus] = useState<"loading" | "fading" | "complete">("loading");

  useEffect(() => {
    // Lock scroll on mount
    document.body.style.overflow = "hidden";

    // Start sliding up at 1000ms
  ...
  return (
    <div
      ...
      style={{
        zIndex: 9999,
        transform: status === "fading" ? "translateY(-100%)" : "translateY(0)",
