        ...
        <div>
          {item.courseUrl ? (
            <a
              ...
              className="group/link text-zinc-550 3xl:text-xl 4xl:text-2xl 5xl:text-3xl inline-flex items-center gap-1.5 text-sm font-semibold transition-colors duration-300 hover:text-black sm:text-base lg:text-lg"
            >
            ...
            <span className="text-zinc-550 3xl:text-xl 4xl:text-2xl 5xl:text-3xl text-sm font-semibold sm:text-base lg:text-lg">
              {item.institution}
            </span>
          )}
        </div>
