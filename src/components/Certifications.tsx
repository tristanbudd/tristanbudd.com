...
function CertificateCard({
  ...
  return (
    <div
      className="group 3xl:p-10 4xl:p-12 5xl:p-16 relative flex flex-col justify-between overflow-hidden rounded-2xl border border-zinc-200/60 bg-white/40 p-8 shadow-xs backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:bg-white/80 hover:shadow-md"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      ...
      {/* Skills / Key Areas */}
      <div className="3xl:mt-10 4xl:mt-12 5xl:mt-14 mt-8 flex flex-col gap-3">
