  ...
  return (
    ...
    >
      <div className="text-zinc-650 3xl:h-20 3xl:w-20 3xl:mb-6 4xl:h-24 4xl:w-24 4xl:mb-8 5xl:h-32 5xl:w-32 5xl:mb-12 relative mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-zinc-100">
        <Database className="3xl:h-[36px] 3xl:w-[36px] 4xl:h-[44px] 4xl:w-[44px] 5xl:h-[64px] 5xl:w-[64px] h-6 w-6" />
      ...
      <button
        onClick={handleRetry}
        disabled={isRetrying}
        className="3xl:mt-8 3xl:px-8 3xl:py-3.5 3xl:text-sm 3xl:gap-3 4xl:mt-10 4xl:px-10 4xl:py-4.5 4xl:text-base 4xl:gap-3.5 5xl:mt-14 5xl:px-14 5xl:py-6 5xl:text-lg 5xl:gap-4 mt-6 inline-flex items-center gap-2 rounded-full border border-black bg-black px-6 py-2.5 text-xs font-bold tracking-wider text-white uppercase transition-all duration-300 hover:bg-zinc-900 disabled:opacity-50"
      >
        <RefreshCw
          className={`h-3.5 w-3.5 ${isRetrying ? "animate-spin" : ""} 3xl:h-[18px] 3xl:w-[18px] 4xl:h-[20px] 4xl:w-[20px] 5xl:h-[24px] 5xl:w-[24px]`}
        />
